...
public class BoggleGame extends JFrame {
     ...
     */
    public BoggleGame(int rows, int cols) throws Exception {
    ...
    private File getFile(String pathname) throws URISyntaxException {
        return new File(getClass().getClassLoader().getResource(pathname).toURI());
    }
