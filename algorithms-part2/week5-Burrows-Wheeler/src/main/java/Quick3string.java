...
public class Quick3string {
    ...
    private static void sort(int[] a, int lo, int hi, int d, String s) {
    ...
    private static int charAt(String s, int startIndex, int d) {
        int realIndex = (startIndex + d) % s.length();
        if (d == s.length())
            return -1;
        return s.charAt(realIndex);
    }
    ...
    // return the dth character of s, -1 if d = length of s
    private static int charAt(String s, int startIndex) {
        int realIndex = startIndex % s.length();
        return s.charAt(realIndex);
    }
